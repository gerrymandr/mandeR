...
#Export to Shapefile
schwartz$id<-as.character(schwartz$id)
reproj@data<-left_join(reproj@data,schwartz)
writeOGR(obj=reproj, dsn="tempdir", layer="Schwartzberg", driver="ESRI Shapefile") 
```
